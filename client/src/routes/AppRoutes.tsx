    ...
    <>
      ...
      <div className="mb-4">
        <FloatingLabelInput
          ...
          name="first_name"
          value={firstName}
          //newInputClassName="bg-black p-10" oif you want to add new desgin.
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
        <div className="max-w-full max-h-[calc(100vh)] overflow-x-auto">
          <Table>
            <TableHeader className="border-b border-gray-100 bg-blue-500 text-white sticky top-0 z-30 text-xs">
              <TableRow>
            ...
            <TableBody>
              {genders.map((gender, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="px-4 py-3 text-center"> {gender.text} </TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
